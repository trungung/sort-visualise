...
import { CallStackInfo } from "./QuickSortInfo";
...
export function QuickSortSidebar({
	sidebarView,
	onSidebarViewChange,
	onSidebarClose,
	frames,
				...
				{sidebarView === "call-stack" ? (
					currentFrame ? (
						<RecursionTree
							...
							activeId={currentFrame.activeNodeId}
							arraySize={currentFrame.array.length}
							className="border-0"
							hideHeader
						/>
					) : (
